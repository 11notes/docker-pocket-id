...
| ---: | ---: | :---: | :---: | :---: |
| 11notes/pocket-id | 41MB | 1000:1000 | ✅ | amd64, arm64 |
| pocket-id/pocket-id | 87MB | 0:0 | ❌ | amd64, arm64 |
  ...
  pocket-id:
    depends_on:
      postgres:
        ...
        restart: true
    image: "11notes/pocket-id:2.13.0"
    <<: *lockdown
    environment:
      TZ: "Europe/Zurich"
      APP_URL: "${FQDN}"
...
* [2.13.0](https://hub.docker.com/r/11notes/pocket-id/tags?name=2.13.0)
* [2.13.0-unraid](https://hub.docker.com/r/11notes/pocket-id/tags?name=2.13.0-unraid)
* [2.13.0-nobody](https://hub.docker.com/r/11notes/pocket-id/tags?name=2.13.0-nobody)
...
# REGISTRIES ☁️
```
docker pull 11notes/pocket-id:2.13.0
docker pull ghcr.io/11notes/pocket-id:2.13.0
docker pull quay.io/11notes/pocket-id:2.13.0
```
...
*created 08.08.2026, 06:10:03 (CET)*